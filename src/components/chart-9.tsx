...
export const Chart9 = () => {
    ...
    useEffect(() => {
		...
		*/
        ...
        var OMData = [ //欧美国家
            // [{name: '中国'}, {name: "挪威", value: 30}],
            // [{name: '中国'}, {name: "丹麦", value: 30}],
            // [{name: '中国'}, {name: "瑞典", value: 30}],
            // [{name: '中国'}, {name: "芬兰", value: 30}],
            [{name: '中国'}, {name: "英国", value: 20}],
            // [{name: '中国'}, {name: "荷兰", value: 30}],
            // [{name: '中国'}, {name: "爱尔兰", value: 30}],
            // [{name: '中国'}, {name: "比利时", value: 30}],
            // [{name: '中国'}, {name: "卢森堡", value: 30}],
            [{name: '中国'}, {name: "法国", value: 10}],
            [{name: '中国'}, {name: "西班牙", value: 10}],
            [{name: '中国'}, {name: "葡萄牙", value: 30}],
            [{name: '中国'}, {name: "德国", value: 50}],
            // [{name: '中国'}, {name: "奥地利", value: 30}],
            [{name: '中国'}, {name: "瑞士", value: 30}],
            [{name: '中国'}, {name: "美国", value: 90}],
            [{name: '中国'}, {name: "加拿大", value: 40}],
            [{name: '中国'}, {name: "澳大利亚", value: 10}],
            [{name: '中国'}, {name: "新西兰", value: 10}]
        ];
